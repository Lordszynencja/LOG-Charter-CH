...
public class MP3Comparator implements Comparator {
   ...
   * MP3File object and if neither objects are MP3Files then they are considered
   * equal. A series of tests are conducted to determine the the outcome. First
   * the artist is tested, then the album, then the track, then the title, then
   * the path.
   *
   ...
   * order to be acceptable, both parameters must not be empty and they must not
   * be equal.
   *
