...
public final class ConfigPane extends ParamsPane {
	...
	public ConfigPane(final CharterFrame frame) {
		...
		addConfigValue(2, "Default charter", charter, 300, null, val -> charter = val);
		...
		addConfigValue(4, "Minimal distance between tail and next note", minLongNoteDistance + "", 50, createIntValidator(
				1, 1000, false),
		...
		addConfigValue(5, "Minimal note tail length", minTailLength + "", 50, createIntValidator(1, 1000, false),
				val -> minTailLength = Integer
						.valueOf(val));
		addConfigValue(6, "Sound delay", delay + "", 50, createIntValidator(1, 10000, false), val -> delay = Integer
				.valueOf(val));
		addConfigValue(7, "Marker position", markerOffset + "", 50, createIntValidator(1, 1000, false),
				val -> markerOffset = Integer
						.valueOf(
								val));
